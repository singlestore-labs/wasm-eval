...
out_onnx = "super_resolution.onnx"

# Export the model
torch.onnx.export(torch_model,               # model being run
                  x,                         # model input (or a tuple for multiple inputs)
                  out_onnx,   # where to save the model (can be a file or file-like object)
...
# optimize, simplify and polish the model
...
onnx.save(optimized_model, out_onnx)
